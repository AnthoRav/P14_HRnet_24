...
export default function EnhancedTable() {
  const { employees } = useContext(EmployeeContext); // Récupérez les employés du contexte
  ...
  const visibleRows = React.useMemo(
    () =>
      ...
      // ),
      stableSort(mockData, getComparator(order, orderBy)).slice(
        page * rowsPerPage,
        page * rowsPerPage + rowsPerPage,
      ),
    ...
    <Box sx={{ width: '80%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
              ...
              {visibleRows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Ajoutez d'autres cellules pour les autres colonnes */}
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
        ...
        <TablePagination
          ...
          count={mockData.length} //nombre total de ligne
